...
class _SearchScreenState extends State<SearchScreen> {
  ...
  fetchSearchedProduct() async {
    productsModel = await searchServices.fetchSearchedProducts(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(
                                context, ProductDetailsScreen.routeName, arguments: productsModel![index]);
                          },
                          child:
                              SearchedProduct(product: productsModel![index]));
                    },
                  ),
                )
              ],
